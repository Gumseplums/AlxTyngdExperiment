...
BackBtn.addEventListener('click', () => {
    if (Step == 1) {
        ...
        InstTitle.innerHTML = 'MATERIAL';
        InstText.innerHTML = '- Plast Fläska<br>- Sax<br>- Garn eller snöre<br>- Tejp<br><br>(Behöves inte men recommenderas)<br>- Stor pärla<br>- Hot glue pistol<br>- Kniv<br>- Penna';
        ...
        InstTitle.innerHTML = 'Steg 2';
        InstText.innerHTML = 'Cut the bottle in half.<br>This is where using a knife can be easier than a scissor';
        ...
        InstTitle.innerHTML = 'Steg 3';
        InstText.innerHTML = 'Now cut it shorter but leave out 4 strips as "legs" for the bottle.<br>This is where you can use a pem/marker to trace it out. The leg strips should be evenly spaced out.<br><br>Be sure to not make the legs too thin as that will give it really bad stability, possibly causing it to collapse. Dont make it too thick either, as the spaces are essencial for the model to work.';
        ...
        InstTitle.innerHTML = 'Steg 5';
        InstText.innerHTML = 'Approximately tape/glue the thread horizontally inside the bottle. Make sure they thread is centered. The two thread will create an X in the middle of the bottle.<br><br> This is Tyngd Punkten.';
        ...
        InstTitle.innerHTML = 'Steg 6';
        InstText.innerHTML = 'Cut another thread of yarn/string. This time it will need to be slightly longer than the length between Tygnd punktet (where the previous threads create an X) and the ground';
        ...
        InstTitle.innerHTML = 'Steg 6.5';
        InstText.innerHTML = 'This is an optional BUT recommended part of the instructions. Tie a bead to the end of the thread to make it heavier. The bead should just barely be not touching the ground.';
        ...
        InstTitle.innerHTML = 'Steg 7';
        InstText.innerHTML = 'Tie the loose thread to the other two threads, specifically where they meet to make an X. Aka, Tyngd Punkten.';
        ...
        InstTitle.innerHTML = 'Finished!';
        InstText.innerHTML = 'Youve finished the model! But you are likely wondering what this weird bottle thread mix is. WELL!<br><br>The bottle is the object. The X thread inside the bottle, which is hopefully centered, is just to give the actuall Tyngt Punkten to hang onto. The hanging string is the arrow that shows where the weight is going. So, if Ive done this correctly, when the bead goes outside the object(waterbottle) should loose balance';
